...
test_that("Function return correct results.", {
  ...
  kd <- knapsack_dynamic(x = knapsack_objects[1:100,], W = 3500)
  expect_equal(round(kd$value), 79608)
  
  kd <- knapsack_dynamic(x = knapsack_objects[1:200,], W = 3500)
  expect_equal(round(kd$value), 98288)
})